...
| --- | --- | --- | --- |
| Jobs | Lead | review | Product vision, architecture decisions, code review, scope management |
| Woz | Lead Dev | edit | TypeScript, React, Vite, system architecture, API integration, devtunnel |
| Kare | Frontend Dev | advisory | React components, CSS/styling, retro UI design, pixel art aesthetics, responsive layout |
| Hertzfeld | Tester | review | Vitest/Jest testing, React Testing Library, integration tests, edge cases, E2E testing |
